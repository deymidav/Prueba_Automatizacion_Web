...
public class CartSteps {
    ...
    public String getCartTitle() {
        ...
        WebElement titleElement = wait.until(ExpectedConditions.visibilityOfElementLocated(CartPage.cartTitle));
        return titleElement.getText().trim();
    }

    public double getUnitPriceCart() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement priceElement = wait.until(ExpectedConditions.visibilityOfElementLocated(CartPage.cartUnitPrice));
    ...
    public int getQuantityFromCart() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement quantityElement = wait.until(ExpectedConditions.visibilityOfElementLocated(CartPage.cartQuantity));
    ...
    public String getCartTotalAmount() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement totalElement = wait.until(ExpectedConditions.visibilityOfElementLocated(CartPage.cartTotalAmount));
    ...
    public void finalizePurchase() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement finalizeButton = wait.until(ExpectedConditions.elementToBeClickable(CartPage.finalizeCartPurchase));
